...
import {removeTodo, updateTodo, toggleComplete, toggleEdit } from '../features/todo/todoSlice';
        ...
        {todos.map((todo) => (
          ...
          <div className={`flex border border-black/10 rounded-lg px-3 py-1.5 gap-x-3 shadow-sm shadow-white/50 duration-300  text-black  ${
              ...
              <input
                ...
                todo.isEditing ? "border-white px-2" : "border-transparent"
                } ${todo.completed ? "line-through" : ""}`}
                value={editTexts[todo.id] || todo.text}
                onChange={
                  (e) => handleInputChange(todo.id, e.target.value)}
            ...
            <button
              ...
              onClick={() => {
                ...
                dispatch(toggleEdit({ id: todo.id ,isEditing: false}));
              }}
